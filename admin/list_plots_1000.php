...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <main class="main">
        ...
        <h2 class="mb-4">لیست نمرات ده بسوه‌ای فروخته شده</h2>
        ...
        <table id="plotsTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                LEFT JOIN pay_1000 pay ON p.id = pay.plot_id
                WHERE p.status = 'sold'
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($row['remaining_amount'] > 0): ?>
                            <a href="pay_plots_1000.php?plot_id=<?= $row['id'] ?>" class="btn btn-sm btn-warning" target="_blank">پرداخت</a>
                        <?php else: ?>
