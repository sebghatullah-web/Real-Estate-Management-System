...
<head>
    ...
    <title>Manage VIP Plot List</title>
    <!-- DataTables CSS -->
...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <main class="main">
        ...
        <h2 class="mb-4">List of Sold VIP Plots</h2>
        ...
        <table id="plotsTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                LEFT JOIN pay_vip pay ON p.id = pay.plot_id
                WHERE p.status = 'sold'
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($row['remaining_amount'] > 0): ?>
                            <a href="pay_plots_vip.php?plot_id=<?= $row['id'] ?>" class="btn btn-sm btn-warning" target="_blank">Payment</a>
                        <?php else: ?>
