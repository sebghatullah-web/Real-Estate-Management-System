...
<head>
    ...
    <title>Manage Five Biswa (510 sqm)</title>
...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <form action="add_plot_510.php" method="POST" class="row g-3">
            <div class="col-md-3">
            ...
            <h2 class="mb-4">List of Five Biswa (510 sqm)</h2>
            ...
            <tbody>
                <?php
                $result = $conn->query("SELECT * FROM plots_510 ORDER BY id ASC");
                ...
                <td>
                    <a href="edit_plot_510.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
                    <a href="delete_plot_510.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>

                    <?php if ($row['status'] == 'available'): ?>
                        <a href="sell_plot_510.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-success" target="_blank">Sell</a>
                    <?php else: ?>
