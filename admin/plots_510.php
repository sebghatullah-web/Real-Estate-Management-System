...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <h2 class="mb-4">لیست نمرات پنج بسوه‌ای</h2>
            ...
            <tbody>
                ...
                <td>
                    <a href="edit_plot_510.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">ویرایش</a>
                    <a href="delete_plot_510.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('آیا مطمئن هستید؟')">حذف</a>

                    <?php if ($row['status'] == 'available'): ?>
                        <a href="sell_plot_510.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-success" target="_blank">فروش</a>
                    <?php else: ?>
