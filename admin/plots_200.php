...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <form action="add_plot_200.php" method="POST" class="row g-3">
            <div class="col-md-3">
            ...
            <h2 class="mb-4">لیست نمرات دو بسوه‌ای</h2>
            ...
            <tbody>
                <?php
                $result = $conn->query("SELECT * FROM plots_200 ORDER BY id ASC");
                ...
                <td>
                    <a href="edit_plot_200.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">ویرایش</a>
                    <a href="delete_plot_200.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('آیا مطمئن هستید؟')">حذف</a>

                    <?php if ($row['status'] == 'available'): ?>
                        <a href="sell_plot_200.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-success" target="_blank">فروش</a>
                    <?php else: ?>
