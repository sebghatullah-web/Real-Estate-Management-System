    ...
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <tbody>
                ...
                <td>
                    <a href="edit_plot_200.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
                    <a href="delete_plot_200.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>

                    <?php if ($row['status'] == 'available'): ?>
                        <a href="sell_plot_200.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-success" target="_blank">Sell</a>
                    <?php else: ?>
